...
class DatasetSpec(Protocol):
    ...
    def build_planning_deps(self, settings, *, cache_gateway: CacheGatewayPort) -> PlanningDependencies: ...
    def build_enrich_deps(self, settings, *, cache_gateway: CacheGatewayPort, secret_store=None): ...
