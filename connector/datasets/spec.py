...
class DatasetSpec(Protocol):
    ...
    def build_planning_deps(self, settings, *, cache_gateway: PlanningRuntimePort) -> PlanningDependencies: ...
    def build_enrich_deps(self, settings, *, cache_gateway: EnrichLookupPort, secret_store=None): ...
