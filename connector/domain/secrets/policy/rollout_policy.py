...
ROLLOUT_REASON_INVALID_MODE = "rollout_mode_invalid"
    ...
    *,
    ...
    if not requested_vault:
        return VaultRolloutDecision(
            ...
            vault_enabled=False,
            startup_guard_required=False,
            force_dry_run=False,
            canary_bucket=None,
            canary_selected=None,
    ...
    if mode != ROLLOUT_MODE_CANARY:
        return VaultRolloutDecision(
            ...
            canary_bucket=None,
            canary_selected=False,
            reason=ROLLOUT_REASON_INVALID_MODE,
        )
