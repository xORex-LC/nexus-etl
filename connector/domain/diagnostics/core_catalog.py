...
def build_core_catalog(*, strict: bool) -> ErrorCatalog:
    ...
    entries = [
        ...
        CatalogEntry("INVALID_BOOLEAN", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        CatalogEntry("INVALID_INT", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        CatalogEntry("INVALID_EMAIL", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        CatalogEntry("INVALID_AVATAR_ID", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        ...
        CatalogEntry("MATCH_KEY_MISSING", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        ...
        CatalogEntry("TARGET_ID_MISSING", SystemErrorCode.DATA_INVALID, severity=DiagnosticSeverity.ERROR),
        CatalogEntry("TARGET_ID_CONFLICT", SystemErrorCode.CONFLICT, severity=DiagnosticSeverity.ERROR),
        CatalogEntry("USR_ORG_TAB_CONFLICT", SystemErrorCode.CONFLICT, severity=DiagnosticSeverity.ERROR),
