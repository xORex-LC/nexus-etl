...
| Файл | Назначение |
|---|---|
| `canonicalization.py` | Generic compiled canonicalization contract: `CompiledCanonicalizeOp`, `CompiledCanonicalizer`, transport-neutral `CompiledPolarsExpressionPlan` и shared Python runtime executor |
...
**Зависит от:** stdlib.  
**Используется:** `domain/transform/enrich/`, `domain/transform/resolver/`, `domain/transform/matcher/`, `infra/polars/`.
